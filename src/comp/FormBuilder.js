...
const FormBuilder = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const formResponse = await fetch('http://localhost:5001/api/creation', {
                method: 'POST',
                headers: {
    ...
    const handleQuestionSubmission = async (formId, question) => {
        ...
        const questionResponse = await fetch('http://localhost:5001/api/questions', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    const sendUserIds = async (selectedUsers, formId) => {
        ...
        const response = await fetch('http://localhost:5001/api/form_users', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
