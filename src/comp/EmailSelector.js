...
const EmailSelector = ({ setSelectedUsers }) => {
    ...
    useEffect(() => {
        const fetchEmails = async () => {
            try {
                const response = await fetch('https://pond-catkin-supermarket.glitch.me/api/emails');
    ...
    const handleEmailInputChange = async (e) => {
        ...
        try {
            const response = await fetch(`https://pond-catkin-supermarket.glitch.me/api/emails?search=${encodeURIComponent(value)}`);
