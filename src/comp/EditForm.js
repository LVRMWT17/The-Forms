...
const EditForm = () => {
    ...
    useEffect(() => {
        const fetchFormData = async () => {
            try {
                const response = await fetch(`https://pond-catkin-supermarket.glitch.me/api/EditForm/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`https://pond-catkin-supermarket.glitch.me/api/edit-the-form/${id}`, {
                method: 'POST',
                headers: {
    ...
    return (
        <form onSubmit={handleSubmit} className='forms'>
            ...
            <img src={imageUrl} alt={formTitle} className='form-image' />
