...
const MainComponent = () => {
    ...
    return (
        ...
        <Routes>
            ...
            <Route path="/FormDetailsAnonim/:id" element={<FormDetailsAnonim />} />
            <Route path="/EditForm/:id" element={<EditForm />} />
            <Route path="/answer/:id" element={<Answers />} />
            <Route path="/responses" element={<Responses />} />
            <Route path="/comp/UserInfEdit" element={<UserInfEdit />} />
            <Route path="*" element={<App />} />
            <Route path="/comp/UsersTable" element={<UsersTable />} />
        </Routes>
    </Router>
    );
};
